...
Rather than treating machine learning architectures as black boxes, this portfolio emphasizes **fundamental numerical optimization from scratch using NumPy**.



### 1. Dimensionality Reduction & Factor Extraction
...
### 3. Unsupervised Regime Classification & State-Space Clustering
